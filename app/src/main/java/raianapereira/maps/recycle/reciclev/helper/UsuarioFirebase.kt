package raianapereira.maps.recycle.reciclev.helper
...
import raianapereira.maps.recycle.reciclev.activity.MapaActivity
        ...
        if (user != null) {
            ...
            usuariosRef.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    if (tipoUsuario == "M") {
                        val i = Intent(activity, MapaActivity::class.java)
